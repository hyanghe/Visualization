...
mlsolver_output_x = np.load('./meshgraphnets/data/deforming_plate/mlsolver_output_z.npy')
...
# 		plt.imshow(mlsolver_output_x[num_time_step, :,:,z_idx])
...
#######################################################################################################3
			...
			interpolated_grid_moving_delta_step_x_v.append(interpolated_grid_moving_delta_step[:,:,:,0])
			interpolated_grid_moving_delta_step_y_v.append(interpolated_grid_moving_delta_step[:,:,:,1])
			interpolated_grid_moving_delta_step_z_v.append(interpolated_grid_moving_delta_step[:,:,:,2])
		...
		np.save('./meshgraphnets/data/deforming_plate/mlsolver_output_x',\
		 interpolated_grid_moving_delta_step_x_v)
		np.save('./meshgraphnets/data/deforming_plate/mlsolver_output_y',\
		 interpolated_grid_moving_delta_step_y_v)
		np.save('./meshgraphnets/data/deforming_plate/mlsolver_output_z',\
		 interpolated_grid_moving_delta_step_z_v)

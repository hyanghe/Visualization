...
# mlsolver_output_x = np.load('./meshgraphnets/data/deforming_plate/mlsolver_z.npy')
...
# # 		plt.imshow(mlsolver_output_x[num_time_step, :,:,z_idx,0])
...
#######################################################################################################3
		...
		# 	# print('world pos: ', w[time_step, :,0][:100])
			...
			im = ax.scatter(grid_coords[:,0], grid_coords[:,1],\
			 grid_coords[:,2], c=grid_moving_delta_step[:, 0], cmap='jet', alpha=0.5)
			...
			im = ax.scatter(grid_coords[:,0], grid_coords[:,1],\
			 grid_coords[:,2], c=grid_moving_delta_step[:, 1], cmap='jet', alpha=0.5)
			...
			im = ax.scatter(grid_coords[:,0], grid_coords[:,1],\
			 grid_coords[:,2], c=grid_moving_delta_step[:, 2], cmap='jet', alpha=0.5)
...
#######################################################################################################3
			...
			first_channel_x_translation = interpolated_grid_moving_delta_step[:,:,:,0:1]
			second_channel_node_type = interpolated_node_type.reshape(*first_channel_x_translation.shape)
			ml_solver_x_translation = np.concatenate((first_channel_x_translation, second_channel_node_type), -1)

			first_channel_y_translation = interpolated_grid_moving_delta_step[:,:,:,1:2]
			# second_channel_node_type = interpolated_node_type.reshape(*first_channel_y_translation.shape)
			ml_solver_y_translation = np.concatenate((first_channel_y_translation, second_channel_node_type), -1)

			first_channel_z_translation = interpolated_grid_moving_delta_step[:,:,:,2:3]
			# second_channel_node_type = interpolated_node_type.reshape(*first_channel_z_translation.shape)
			ml_solver_z_translation = np.concatenate((first_channel_z_translation, second_channel_node_type), -1)
